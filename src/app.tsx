...
export default function App() {
    ...
    return <main className={'flex flex-col relative w-screen h-screen'}>
        <header className={'font-bold text-6xl p-2 bg-neutral-700 text-yellow-600'}>
            Spaghetti House
        </header>
        <section className={'flex flex-col gap-4 mt-4 p-4 relative'}>
            <article className={'flex flex-col w-screen gap-4'}>
            ...
            <article className={'flex gap-4 h-full justify-between'}>
